...
public class AnalyticsController {
    ...
    public ResponseEntity<List<ConsultantStatsResponse>> consultantStats(
        ...
        return ResponseEntity.ok(analyticsService.getConsultantStats(storeId, dateFrom, dateTo));
    }
    ...
    public ResponseEntity<ConsultantStatsResponse> consultantDetail(
            ...
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) OffsetDateTime dateFrom,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) OffsetDateTime dateTo) {
        return ResponseEntity.ok(analyticsService.getConsultantDetail(userId, dateFrom, dateTo));
    }
    ...
    public ResponseEntity<RequestHistoryResponse> requestHistory(
        ...
        return ResponseEntity.ok(
                analyticsService.getRequestHistory(storeId, departmentId, status, dateFrom, dateTo, page, size));
    }
}
